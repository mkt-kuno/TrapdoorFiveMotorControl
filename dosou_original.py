...
df = pandas.read_csv('20221119_24642_H10_Dr40.csv')
# 平行方向のデータを落とす
df = df.drop(df.columns[[i for i in range(9,59,2)]], axis=1)
...
cal=[
    ...
    0.1517, 0.1648, None,   0.1609, None,
    0.1582, 0.1706, 0.1624, 0.1505, 0.1699,
    0.1633, 0.1567, 0.132,  0.1601, 0.1611,
    0.1648, 0.1637, 0.1549, 0.1714, 0.1531
]
con=[
    17.471,  -0.3595, -0.0919, -0.6789, -2.0629,
    30.342,  2.9226 , None   , 2.5426 , None,
    -8.6592, 0.0213 , 0.806  , 1.2446 , -0.4462,
...
df_dist = df_dist.drop(df.columns[[0,1,2,3,4,5,7,9,10,14,15,19,20,24,25,29]], axis=1)
